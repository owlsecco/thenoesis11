    ...
    <Section>
      <NavContainer>
        ...
        >
          ...
          <div style={{marginLeft: '15px', marginRight: '15px'}}><Link to="/" style={{fontWeight: 'bolder', color: fill}}>Home</Link></div>
          <div style={{marginLeft: '15px', marginRight: '15px'}}><Link to="/about" style={{fontWeight: 'bolder', color: fill}}>About</Link></div>
        </LogoLink>
        <NavControls>
          {showBackArrow ? (
            <button
